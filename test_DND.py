...
parser.add_argument('--result_dir', default='./results/DND_80/test/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./pretrained_models/model_best_80.pth', type=str, help='Path to weights')
